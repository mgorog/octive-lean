...
/-! Auto-generated from `interactive_explainer.m` — mechanical translation only.
...
-- =================================================================
disp("\linsolve(n, n=== Problem 1: Capitalized Initials ======================");
disp("Requirements:");
...
input("\\nPress Enter to run Problem 1 full_name = input("Enter your full name (with middle initial): ", "s');
full_name = strtrim(full_name);
words = strsplit(full_name);
if isempty(words)
    Initials = "";
...
-- =================================================================
disp("\linsolve(n, n=== Problem 2: Pig Latin Function =========================");
disp("Requirements:");
...
input("\\nPress Enter to test the function disp("Testing single words word1 = input("Enter a word: ", "s");
...
-- =================================================================
disp("\linsolve(n, n=== Problem 3: Rectangle Printer ===========================");
disp("Requirements:");
...
input("\\nPress Enter to draw a rectangle len = input("Enter length (rows): ");
